...
// Create Angular linker plugin inline (avoids importing from tabby)
...
export default () => {
    ...
    const sourceMapOptions = {
        ...
        filename: '[file].map',
        moduleFilenameTemplate: 'webpack-tabby-command-editor:///[resource-path]',
    }
    ...
    if (process.env.PLUGIN_BUNDLE_ANALYZER === 'command-editor') {
